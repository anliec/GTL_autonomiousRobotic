...
class MappingKFBase(RoverKinematics):
    def __init__(self, initial_pose, initial_uncertainty):
        ...
        self.idx = {}
        self.pose_pub = rospy.Publisher("~pose_basic", PoseStamped, queue_size=1)
        self.marker_pub = rospy.Publisher("~landmarks_basic", MarkerArray, queue_size=1)
    ...
    def h_loc(X, L):
        ...
        return MappingKFBase.getRotation(-X[2, 0]) * dist, dist
